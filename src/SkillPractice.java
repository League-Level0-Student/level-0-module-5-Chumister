...
int Sparta= Integer.parseInt(i);


// Tell them how many cents they have (hint multiply by 10)
JOptionPane.showConfirmDialog(null, "You have "+ (10*Sparta) +" cents");



// Ask the user how tall they are (inches)

String k = JOptionPane.showInputDialog("How tall are you?");
int Athens = Integer.parseInt(k);
